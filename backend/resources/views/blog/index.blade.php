...
@section('meta_description', 'Read our latest blog posts on ' . config('app.name') . '.')
@section('meta_keywords', 'blog, posts, laravel cms, articles')
@section('meta_image', asset('images/og-default.png'))
